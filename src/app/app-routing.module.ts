...
const routes: Routes = [
  ...
  { path: 'viaje/:iditem', loadChildren: './tab1/pages/viaje/viaje.module#ViajePageModule' },
  ...
  { path: 'pages/:iditem', loadChildren: './tab1/pages/tabsviaje/tabsviaje.module#TabsviajePageModule' },
